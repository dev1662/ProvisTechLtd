        ...
        <section id="portfolio" class="portfolio">
            ...
            <div class="desc_features">
                ...
                <span class="font-23" style="font-weight: 100;">
                    Let machines sense, comprehend, act and learn to help you take better, faster and accurate
                    decisions.
            ...
            <div class="container steps-start" style="margin-top:2rem;">
                <div class="row gap-y">
                    <div class="col-md-8 mx-auto mb-7" style="margin-bottom:2rem;">
                        <img src="{{ asset('07/undraw_Artificial_intelligence_oyxx.png') }}" alt="Alternative Text"
                            data-aos="fade-up" data-aos-duration="2000" class="aos-init aos-animate">
                    </div>
                    <div class="w-100"></div>
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                ...
                                {{-- <i class="icon-mobile lead-6" style="color: #f75949;"></i> --}}
                                {{-- <i class="fa-regular fa-mobile lead-6" style="color: #f75949;"></i> --}}
                                <i class="fa-light fa-mobile lead-6" style="color: #f75949;"></i>
                            </div>
                            <div class="media-body">
                                <h5>Smart Platform</h5>
                                <p>Oas36ty platform is a smart unification of machine learning and artificial
                                    intelligence. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                {{-- <i class="fa fa-compress lead-6"
                                    style="color: #e2321f;"></i> --}}
                                <i class="fa-sharp fa-solid fa-gears lead-6" style="color: #f75949;"></i>
                            </div>
                            <div class="media-body">
                                <h5>Create Result
                                </h5>
                                <p>Our innovative & customised platform integrates, analyses, creates and presents all
                                    your data and analytics through AI & ML technology. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                ...
                                <i class="fa-solid fa-screwdriver-wrench lead-6" style="color: #f75949;"></i>
                            </div>
                            <div class="media-body">
                                <h5>Data Analysis & Reports
                                </h5>
                                <p>Advanced Data Analytics & Reports creates predictive analysis for business. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                {{-- <i class="icon-layers lead-6" style="color: #e2321f;"></i> --}}
                                <i class="fa-solid fa-layer-group lead-6" style="color: #f75949;"></i>
                                {{-- <i class="fa-solid fa-clock-rotate-left" style="color: #f75949;"></i> --}}
                            </div>
                            <div class="media-body">
                                <h5>Escalation Report
                                </h5>
                                <p>Escalation Reporting System shares a report with you as soon as business requires it.
                                    No need to pull manual reports any more.
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                {{-- <i class="fa fa-calculator lead-6"
                                    style="color: #e2321f;"></i> --}}
                                <i class="fa-solid fa-recycle lead-6" style="color: #f75949;"></i>
                            </div>
                            <div class="media-body">
                                <h5>Journey Tracker
                                </h5>
                                <p>Journey tracker formation supports transparent work execution and no team conflicts.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="media">
                            <div class="line-height-1 w-70px">
                                ...
                                <i class="fa-regular fa-comments lead-6" style="color: #f75949;"></i>
                            </div>
                            <div class="media-body">
                                <h5>Support</h5>
                                <p>When you purchase this software, you'll freely receive future updates. </p>
                            </div>
                        </div>
                    </div>
