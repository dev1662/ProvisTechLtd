...
<head>
    ...
    <style>
        ...
        .animated-text {
            ...
            white-space: nowrap;
            overflow: hidden;
            animation: typing 10s steps(200) alternate infinite;
        }
...
<body>
    ...
    <div class="loader-container">
        ...
        <span class="animated-text">Please Wait...</span>
    </div>
    <!-- ======= Top Bar ======= -->
    ...
    <main id="main">
        <section id="portfolio" class="portfolio">
            ...
            <div class="calendly-inline-widget"
                data-url="https://calendly.com/amarpal-1/book-a-demo?primary_color=ff7200"
