        ...
        <section id="portfolio" class="portfolio">
            ...
            <div class="container" style="margin-top:2rem;">
                <main class="main-content">
                    <div class="container">
                        <h2 class="has-text-align-center">Updates</h2>
                    </div>
                    <div class="container">
                        <div style="height:20px" aria-hidden="true" class="wp-block-spacer"></div>
                    </div>
                    <div class="container">
                        <p class="has-text-align-center">We are on the path of excellence and coherence. Our team is
                            very vibrant and excited to come up with the latest updates and enhancements. <br>Checkout
                            our latest software updates here.</p>
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        <blockquote class="wp-block-quote">
                            <p><strong>New Enhancement</strong><br>Users who have” P&amp;L view” privilege will be able
                                to view Proposal Amount, Invoice Amount, Receipt Amount, Time cost, % of the cost of the
                                proposal in their task page and in the downloaded excel after “Members” column via task
                                and lead download by enabling the “P&amp;L view”.</p>
                            <p><cite>18-Aug-2020</cite></p>
                        </blockquote>
                    </div>
                </main>
            </div>
