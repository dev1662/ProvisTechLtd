    ...
    <main id="main">
        <section id="portfolio" class="portfolio">
            ...
            <div class="img-work">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto"><img
                                src="https://www.oas36ty.com/wp-content/uploads/2020/05/undraw_online_payments_luau-1.png"
                                alt=""></div>
                    </div>
                </div>
            </div>
            ...
            <div class="desc_features">
                ...
                <span class="font-23" style="font-weight: 100;">
                    The plan you choose really depends on what growth stage your business is at, and what you need
                    Oas36ty to help you with.
            ...
            <div class="text-center"><a href="{{ route('book-demo') }}"><button
                        class='demo-btn text-uppercase mb-5'>Get a demo now</button></a></div>
            ...
            <section style="background-color: #f9fafa;">
                ...
                <div class="container steps-start" style="margin-top:2rem;">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <p class="text-uppercase" style="letter-spacing: 2px;"><strong>Pricing Plans</strong></p>
                            <h3 class="mb-5">
                                Choose your pricing plan,
                                <br>
                                No hidden fees!
                            </h3>
                            <p>We have multiple plan which you can choose to pay monthly or yearly. You can always
                                cancel your subscription anytime from your account.</p>



                            <div class="nav nav-pills d-flex gap-2" id="nav-tab" role="tablist">
                                <button class="nav-link active btn-primary" id="monthly-tab" data-bs-toggle="tab"
                        ...
                        <div class="col-md-6 mt-5 mt-md-0">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane bg-transparent fade show active" id="monthly" role="tabpanel"
                                    aria-labelledby="monthly-tab" tabindex="0">
                                    <div class="card card-body text-center py-5 border-0 mx-5">
                                        <p class="lead text-uppercase mb-0"
                                            style="letter-spacing: 2px;font-weight:600">BILLED MONTHLY</p>
                                        <!-- <p>Per Month</p> -->
                                        <p style="font-size: 3rem;" class="mb-0 text-secondary">₹5,000</p>
                                        <p style="margin-top: -1rem; font-weight:900">(5 users)</p>
                                        <p>Complete Office-Automation<br>Encyclopedic Board<br>Customer Support</p>
                                        <br>
                                        <div><a class="btn btn-outline-primary btn-md btn-round"
                                                href="{{ route('oas-contact') }}" style="min-width: 200px;"> Get
                                                started </a></div>
                                    </div>
                                </div>
                                <div class="tab-pane bg-transparent fade" id="yearly" role="tabpanel"
                                    aria-labelledby="yearly-tab" tabindex="0">
                                    <div class="card card-body text-center mx-5 py-5 border-0">
                                        <p class="lead text-uppercase mb-0"
                                            style="letter-spacing: 2px;font-weight:600">BILLED YEARLY</p>
                                        <!-- <p>Per Month</p> -->
                                        <p style="font-size: 3rem;" class="mb-0 text-secondary">₹60,000</p>
                                        <p style="margin-top: -1rem; font-weight:900">(5 users)</p>
                                        <p>Complete Office-Automation<br>Encyclopedic Board<br>Customer Support</p>
                                        <br>
                                        <div><a class="btn btn-outline-primary btn-md btn-round"
            ...
            <div class="text-center text-secondary mt-5"><small>FAQ</small></div>
            <br>
            <h2>
                <b>

                    A software you can trust. Here’s why!
                </b>
            </h2><br>
            <div class="desc_features">
                ...
                <div class="row">
                    <div class="col-md-8 mx-md-auto">
                        <div class="accordion-container">
                            <h5 class="accordion">Is this a secure site for purchases?</h5>
                            <div class="panel">
                                <p>Absolutely! We work with top payment companies which guarantees your safety and
                        ...
                        <div class="accordion-container">
                            <h5 class="accordion">Do you provide support?</h5>
                            <div class="panel">
                                <p>Yes! We’re ready to answer all your questions with email support for all software
                                    Live chat support is available in our software.</p>
                            </div>
                        </div>
                        <div class="accordion-container">
                            <h5 class="accordion">Is my data is secure ?</h5>
                            <div class="panel">
                                <p>Completely safe. Our servers are protected physically and electronically.</p>
                            </div>
                        </div>
                        <div class="accordion-container">
                            <h5 class="accordion">Do i need to install any software ?</h5>
                            <div class="panel">
                                <p>Oas36ty is 100% web-based, so you just need an internet connection and browser. You
                                    can, however, download and install our mobile in Android and iOS .</p>
                            </div>
                        </div>
                        <div class="accordion-container">
                            <h5 class="accordion">Do u have any cancellation policy?</h5>
                            <div class="panel">
                                <p>Although we hope you find Oas36ty a good fit, you can cancel at any time.</p>
                            </div>
                        </div>
                    </div>
                </div>
